var calOptions = {
    ...
    useDetailPopup: true,
    theme: {
        'common.border': '1px solid rgba(255,255,255,0.25)',
        'common.backgroundColor': 'rgba(0,0,0,0.25)',
        'week.timegridLeft.backgroundColor': 'rgba(0,0,0,0.25)',
    }
};
...
Gemütlich! `,
    ...
    
        {
            ...
            body: `Wie ihr vielleicht schon gesehen habt bieten wir zu speziellen Themen auch gesonderte Q&amp;As an. Trotzdem könnt ihr uns hier schonmal mit sämtlichen Fragen rund ums Studieren, Leben in Karlsruhe oder was euch sonst so einfällt, löchern.
Selbst wenn das Thema noch einmal gesondert in einem anderen Stream behandelt wird, bekommt ihr hier vielleicht auch Eindrücke von anderen Tutoren.
Zögert nicht uns Fragen zu stellen!`,
    ...
    
        {
            ...
            title: "FBI (FS)",
            body: `
Fachbereichsinfos, täglich wechselnd
...
//ignore`,
    ...
    
        {
            ...
            category: "time",
            title: "Live Musik",
            body: `&lt;b&gt;Robert&lt;/b&gt; holt das Keyboard raus. Chillstream.`,
...
//ignore`,
    ...
    
        {
            ...
            body: `&lt;br&gt;Das etwas andere (Spassige) Tutorium.&lt;br&gt;&lt;br&gt;Mit &lt;b&gt;Benedikt&lt;/b&gt; eurem Lieblings LA Tutor.`,
...
//ignore`,
    ...
    
        {
            ...
            category: "time",
            title: "Talk: Tichy",
            body: `&lt;br&gt;Wir reden mit Prof. &lt;b&gt;Walter F. Tichy&lt;/b&gt;.&lt;br&gt;&lt;br&gt;Er hat lange die Vorlesung Softwaretechnik 1 (2. Semester) gehalten. Neben dem fachlichen interessiert Ihn das Aufrechterhalten einer strukturierten Arbeitsweise unter Studenten. Wir reden mit Ihm über Organisation, Motivation und den Aufbau eines erfolgreichen Studienalltag.&lt;br&gt;&lt;br&gt;Wir werden immer wieder einen Blick auf den Chat werfen, diesen aber größtenteils indirekt Einbinden.&lt;br&gt;&lt;br&gt;Diese Ereignis wird auch über den Kanal der Fachschaft übertragen.`,
